 ...
 * Generated for Laravel 5.6.20 on 2018-05-04 10:09:42.
 *
...
namespace Ably\Laravel\Facades { 
    ...
    class Ably {
         ...
         * @static 
         */ 
        public static function channel($name, $options = array())
        {
            return \Ably\AblyRest::channel($name, $options);
        }
        ...
        {
            return \Ably\AblyRest::stats($params);
        }
        ...
        {
            return \Ably\AblyRest::systemTime();
        }
         ...
         * @static 
         */ 
        public static function get($path, $headers = array(), $params = array(), $returnHeaders = false, $auth = true)
        {
            return \Ably\AblyRest::get($path, $headers, $params, $returnHeaders, $auth);
        }
         ...
         * @static 
         */ 
        public static function post($path, $headers = array(), $params = array(), $returnHeaders = false, $auth = true)
        {
            return \Ably\AblyRest::post($path, $headers, $params, $returnHeaders, $auth);
        }
         ...
         * @static 
         */ 
        public static function requestInternal($method, $path, $headers = array(), $params = array(), $returnHeaders = false, $auth = true)
        {
            return \Ably\AblyRest::requestInternal($method, $path, $headers, $params, $returnHeaders, $auth);
        }
         ...
         * @static 
         */ 
        public static function request($method, $path, $params = array(), $body = '', $headers = array())
        {
            return \Ably\AblyRest::request($method, $path, $params, $body, $headers);
        }
        ...
        {
            return \Ably\AblyRest::setLibraryFlavourString($flavour);
        }
...
namespace  { 
    ...
    class Ably extends \Ably\Laravel\Facades\Ably {}
